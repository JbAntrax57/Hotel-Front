        ...
        <q-page-container class="full-width">
          <q-page class="flex flex-center bg-grey-2">
            <q-card class="q-pa-md shadow-0 my_card" bordered> <!-- cambiar a shadow-2 para sombreado por defecto -->
              ...
              <!-- :style="isMobile() ? 'width: 24rem; righ: 0% !important; max-height: 75vh' : 'width: 30rem; left: -32% !important;'" -->
              <q-card v-morph:card1:mygroup:500.resize="morphGroupModel"
                class="absolute-bottom-left bg-white text-white text-center" style="width: 40rem; left: -32% !important;">
...
//   import { useStore } from 'vuex'
  ...
  export default {
    ...
    methods: {
      ...
      watch: {
        screenWidth(val) {
          this.screen_size = (val > 500) ? 'pc' : 'smartphone'
        }
      }
    }
  };
